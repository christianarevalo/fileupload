...
class FileUpload {
  ...
  protected $messages = array(
    // PHP $_FILES-own
      UPLOAD_ERR_INI_SIZE       => 'file_upload.error.ini_size',
      UPLOAD_ERR_FORM_SIZE      => 'file_upload.error.form_size',
      UPLOAD_ERR_PARTIAL        => 'file_upload.error.partial',
      UPLOAD_ERR_NO_FILE        => 'file_upload.error.no_file',
      UPLOAD_ERR_NO_TMP_DIR     => 'file_upload.error.no_temp_dir',
      UPLOAD_ERR_CANT_WRITE     => 'file_upload.error.write',
      UPLOAD_ERR_EXTENSION      => 'file_upload.error.php_extension',

    // Our own
      self::UPLOAD_ERR_PHP_SIZE => 'file_upload.error.php_size'
  );
